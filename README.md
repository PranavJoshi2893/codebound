...
```
 ...
 > **Alpha Notice:** CodeBound is currently in **v0.1.4-nightly.2**. APIs, project layouts, and behaviors may change as the project evolves and we gather community feedback.
...
---
 ...
 CodeBound is currently **`v0.1.4-nightly.2`**.
